...
shield_db = {
    ...
    "LFP_2": {
        ...
        "WithConstField" : False,
        "params": [
            120.50, 208.88, 265.11, 264.50, 173.76, 165.46, 216.07,  
            50.00,  50.00, 119.00, 119.00,   2.00,   2.00,   1.00,   1.00,  50.00,  50.00, 0.00,   0.00,   0.00,
            68.75,  67.44,   9.01,  58.62,   2.00,  36.97,   1.00,  1.03,  68.75,  69.15,   0.00,   0.00,   0.00,
            62.63,   9.71,  46.70,  88.74,   2.11,   2.08,   1.00,   1.00,  62.63,   9.71,   0.00,   0.00,   0.00,  
            19.07,  34.61,  45.67,  46.93, 108.44,   2.20,   1.00,   1.00,  19.07,  34.61,   0.00, 0.00,   0.00,   
            5.26,  55.63,  39.86,   5.28,   2.00,   2.00,   1.00,   0.90,  5.26,  50.07,   0.10,   0.10,   0.00,  
            33.02,  12.83, 123.27,  78.52,  22.41,  2.00,   0.96,   0.95,  31.66,  12.23,   0.10,   0.10,   0.00,  
            15.75,  77.29,  69.40, 152.83,   2.00,  35.40,   1.00,   0.90,  15.75,  69.56,   0.00,   0.00,  0.00
            ]
    },
    
    "Piet_No_line_no_Cavern": {
        "Hybrid_flag": False,
        "WithConstField" : False,
        "params": [ 230.00, 375.00, 245.00, 212.37, 0.00, 131.97, 181.51,
                         30.00, 30.00, 20.00, 20.00, 30.00, 30.00, 1.17, 1.17, 144.00, 144.00, 0.00, 0.00, 0.00,
                         41.88, 34.77, 27.00, 43.00, 15.78, 2.18, 4.63, 4.57, 34.00, 34.00, 0.00, 0.00, 0.00,
                         26.07, 46.29, 43.00, 56.00, 3.62, 5.08, 4.62, 4.75, 44.00, 44.00, 0.00, 0.00, 0.00,
                         1.09, 14.94, 56.00, 56.00, 2.01, 6.51, 4.50, 4.65, 44.00, 44.00, 0.00, 0.00, 0.00,
                         64.40, 68.10, 56.00, 56.00, 6.00, 6.00, 0.46, 0.15, 44.00, 44.00, 0.00, 0.00, 0.00,
                         12.13, 31.97, 56.00, 56.00, 2.00, 2.00, 3.82, 5.06, 44.00, 44.00, 0.00, 0.00, 0.00,
                         32.68, 39.81, 56.00, 56.00, 2.00, 2.00, 3.39, 3.32, 44.00, 44.00, 0.00, 0.00, 0.00,
                         ]
    },
        
    "Piet_No_line_with_Cavern": {
        "Hybrid_flag": False,
        "WithConstField" : False,
        "params": [ 230.00, 375.00, 245.00, 243.68, 0.00, 163.73, 182.73,
                              30.00, 30.00, 20.00, 20.00, 30.00, 30.00, 1.17, 1.17, 144.00, 144.00, 0.00, 0.00, 0.00,
                              39.99, 33.05, 27.00, 43.00, 2.20, 5.54, 5.24, 4.31, 34.00, 34.00, 0.00, 0.00, 0.00,
                              28.70, 38.62, 43.00, 56.00, 2.20, 2.00, 3.69, 4.14, 44.00, 44.00, 0.00, 0.00, 0.00,
                              1.96, 20.48, 56.00, 56.00, 50.23, 2.00, 4.43, 1.00, 44.00, 44.00, 0.00, 0.00, 0.00,
                              64.40, 68.10, 56.00, 56.00, 6.00, 6.00, 0.46, 0.15, 44.00, 44.00, 0.00, 0.00, 0.00,
                              12.15, 41.28, 56.00, 56.00, 2.20, 14.21, 4.79, 3.55, 44.00, 44.00, 0.00, 0.00, 0.00,
                              14.60, 52.53, 56.00, 56.00, 4.95, 2.20, 4.59, 3.40, 44.00, 44.00, 0.00, 0.00, 0.00,]
    },
            
    "Piet_line_No_Cavern": {
        "Hybrid_flag": False,
        "WithConstField" : False,
        "params": [ 230.00, 375.00, 245.00, 195.77, 0.00, 129.63, 171.99,
                    30.00, 30.00, 20.00, 20.00, 30.00, 30.00, 1.17, 1.17, 144.00, 144.00, 0.00, 0.00, 0.00,
                    41.96, 36.66, 27.00, 43.00, 51.91, 21.43, 1.69, 3.05, 34.00, 34.00, 0.00, 0.00, 0.00,
                    57.18, 31.01, 43.00, 56.00, 2.00, 9.43, 1.94, 4.29, 44.00, 44.00, 0.00, 0.00, 0.00,
                    13.44, 12.46, 56.00, 56.00, 17.37, 2.00, 10.61, 13.06, 44.00, 44.00, 0.00, 0.00, 0.00,
                    64.40, 68.10, 56.00, 56.00, 6.00, 6.00, 0.46, 0.15, 44.00, 44.00, 0.00, 0.00, 0.00,
                    15.05, 34.56, 56.00, 56.00, 6.37, 37.93, 10.35, 3.11, 44.00, 44.00, 0.00, 0.00, 0.00,
                    8.07, 53.61, 56.00, 56.00, 16.84, 15.02, 19.22, 2.08, 44.00, 44.00, 0.00, 0.00, 0.00,
                    ]
    },
    
    "Piet_line_with_Cavern": {
        "Hybrid_flag": False,
        "WithConstField" : False,
        "params": [ 230.00, 375.00, 245.00, 180.65, 0.00, 155.96, 280.10,
                    30.00, 30.00, 20.00, 20.00, 30.00, 30.00, 1.17, 1.17, 144.00, 144.00, 0.00, 0.00, 0.00,
                    51.05, 24.92, 27.00, 43.00, 2.00, 2.00, 2.19, 5.74, 34.00, 34.00, 0.00, 0.00, 0.00,
                    5.25, 80.82, 43.00, 56.00, 2.00, 16.62, 30.98, 0.94, 44.00, 44.00, 0.00, 0.00, 0.00,
                    1.00, 5.65, 56.00, 56.00, 35.98, 2.00, 136.42, 29.97, 44.00, 44.00, 0.00, 0.00, 0.00,
                    64.40, 68.10, 56.00, 56.00, 6.00, 6.00, 0.46, 0.15, 44.00, 44.00, 0.00, 0.00, 0.00,
                    1.00, 12.10, 56.00, 56.00, 28.86, 80.00, 147.34, 7.27, 44.00, 44.00, 0.00, 0.00, 0.00,
                    24.52, 51.80, 56.00, 56.00, 2.00, 2.00, 6.26, 2.44, 44.00, 44.00, 0.00, 0.00, 0.00,
                    ]
    },
